...
for sim in sim_list:
    ...
    print("Downsample",sim)
    for frame in this_sim.ann_frames[-1:]:
        base_dir="/data/cb1/Projects/P49_EE_BB/Simulations_128_downsample"
        ...
        DOON.downsample_and_write(ds,dest_fname, refine_by=4, write_hdf5=True,write_fits=False)
        if 0:
