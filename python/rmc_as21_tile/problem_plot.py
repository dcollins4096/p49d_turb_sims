...
for fname in glob.glob('ImageTileWindow*.out'):
    print("Reading",fname)
    ...
    for stokes in ['Q','U','I']:
        ...
        oname =  "as21_tilewindow_DD%04d_th%04d_ph%04d_%s.png"% (1,theta,phi,stokes)
        onamef = "as21_tilewindow_DD%04d_th%04d_ph%04d_%s.fits"%(1,theta,phi,stokes)
        plt.savefig(oname)
