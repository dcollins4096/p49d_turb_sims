...
all_frames={}
for sim in simlist:
    analysis_frames[sim] = range(20,1000)
    all_frames[sim]=list(range(1,1000))

data_base = "/anvil/scratch/x-ux454321/Paper83/suite_7_128_athena/"
product_base = "/anvil/scratch/x-ux454321/Paper83/suite_7_128_athena/products"
...
for sim in simlist:
    simulation.sim(longname[sim], data_location="%s/%s"%(data_base,longname[sim]), 
                   ...
                   all_frames=all_frames[sim],framelist=analysis_frames[sim], code='Athena')
