...
line_by_alf_mach  = {'0.5':':','1.5':'--','3':'-'}
marker_by_alf_mach = {'0.5':'.','1.5':'^','3':'s'}
...
for counter,sim in enumerate(simlist):
    ...
    longname[sim] = 'b%s_Ms%0.1f_Ma%0.1f_256'%(letter, ms, ma)
ms_list=nar(ms_list)
ma_list=nar(ma_list)
...
analysis_frames={}
for sim in simlist:
    analysis_frames[sim] = range(1,18)
